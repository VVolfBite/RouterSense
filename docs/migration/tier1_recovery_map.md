...
> **Current status (2026-07-19): archived historical evidence.** The current
> formal scheduler mainline is the `gmwd` / `rsbc` / `rscf` P012 family. The
> old Tier-1 witnesses are retained under `tests/legacy/tier1/` and are not an
> all-ready deployment gate. Their historical exact-recovery claims apply to
> the recorded recovery commit, not to the refactored P012 runtime.
...
tests/legacy/tier1/test_tier1_historical_regression.py
```
