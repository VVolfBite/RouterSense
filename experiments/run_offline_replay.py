        ...
        for bucket_rows in bucket_rows_values:
            ...
            for window in windows:
                ...
                for policy_name in policies:
                    resolved_policy = PlannerRegistry.resolve(policy_name)
                    canonical_policy_name = str(resolved_policy.planner_id)
                        ...
                        rows.append(
                            {
                                ...
                                "canonical_policy_name": canonical_policy_name,
                                "builder_policy_name": canonical_policy_name,
                                "hint_type": hint_type,
