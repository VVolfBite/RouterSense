...
def _build_plan(local_context: Any, global_contexts: tuple[Any, ...]) -> Any:
    # This gate validates the distributed transport and agreement path.  It
    # deliberately uses a canonical deployable phase-local policy rather than
    # a retired scheduling-family implementation.
    plan = BirkhoffPhaseLocalPolicy(bucket_rows=1).build_plan(
