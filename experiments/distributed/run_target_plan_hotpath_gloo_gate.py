...
def _run_attempt(rank: int, p2p_group: Any, attempt: int) -> dict[str, Any]:
    ...
    return {
        ...
        "safe_prepared_ready": {
            ...
            "joint_candidate_logical_plan_digest": str(getattr(safe_ready_plan, "joint_candidate_logical_plan_digest", "")),
            "local_fallback_logical_plan_digest": str(getattr(safe_ready_plan, "local_fallback_logical_plan_digest", "")),
        ...
        "safe_late_suffix": {
            ...
            "joint_candidate_logical_plan_digest": str(getattr(safe_late_plan, "joint_candidate_logical_plan_digest", "")),
