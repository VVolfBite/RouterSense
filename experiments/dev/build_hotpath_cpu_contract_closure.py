...
def _gpu_validation_manifest(*, commit: str) -> dict[str, Any]:
    return {
        ...
        "expected_plan_build_upper_bound": {
            ...
            "routersense_u_core_zero_raw_async_per_rank": 4,
            "routersense_u_core_zero_raw_async_per_selected_layer": 2,
