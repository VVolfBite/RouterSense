...
def _gpu_validation_manifest(*, commit: str) -> dict[str, Any]:
    return {
        ...
        "expected_hook_counts": {
            ...
            "prediction_source_p0_per_rank": 0,
            "prediction_source_p0_all_rank": 0,
            "none_heavy_all_rank": 0,
            "u_zero_joint_candidate_all_rank_upper_bound": 16,
        },
        "expected_plan_build_upper_bound": {
            "forward_count": 2,
            "selected_layer_ids": [0, 1],
            "routersense_current_p012_joint_event_rscf_async_per_rank": 4,
            "routersense_current_p012_joint_event_rscf_async_per_selected_layer": 2,
            "routersense_current_p012_joint_event_rscf_async": 16,
        },
        ...
        "preflight_contract": {
            "requested_preflight_mode": "compact",
            "effective_preflight_mode": "compact",
            "mismatch_is_eligible": False,
        },
        "eligible_ineligible_rules": {
            "missing_rank_summary": "ineligible",
            "duplicate_rank_id": "ineligible",
            "missing_count_field": "ineligible",
            "none_heavy_hook_count_positive": "ineligible",
            "exact_hook_count_mismatch": "ineligible",
            "joint_candidate_build_upper_bound_exceeded": "ineligible",
        },
        "exact_gpu_commands": [
            "python experiments/distributed/run_gpu_a2_strategy_compare.py --config configs/official/gpu_hotpath_iteration.yaml --output-dir outputs/tuning/hotpath_count_smoke --world-size 4 --selected-layers 0,1 --warmup-iters 1 --measure-iters 1 --profile perf --preflight-mode compact --strategies native routersense_current_p012_local_event_rscf_async routersense_current_p012_joint_event_rscf_async",
            "python experiments/distributed/run_gpu_a2_strategy_compare.py --config configs/official/gpu_hotpath_iteration.yaml --output-dir outputs/tuning/hotpath_perf_smoke --world-size 4 --selected-layers 0,1 --warmup-iters 1 --measure-iters 2 --profile perf --preflight-mode compact --strategies native routersense_current_p012_local_event_rscf_async routersense_current_p012_joint_event_rscf_async",
        ],
        "forbidden_tests": [
