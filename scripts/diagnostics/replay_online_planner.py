...
def _parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    ...
    parser.add_argument("--mode", default="phase_sync_wave", choices=("phase_sync_wave",))
...
def main(argv: list[str] | None = None) -> int:
    ...
    # Historical pending-window replay was removed from the formal tree.
    # This diagnostic now replays only the canonical phase planner surface.
