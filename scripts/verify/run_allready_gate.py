...
def main(argv: list[str] | None = None) -> int:
    ...
    report: dict[str, Any] = {
        "schema_version": "routersense.allready.gate.v1",
    ...
    if args.skip_trace_modes:
        report["stages"]["trace_mode_matrix"] = {"status": "SKIPPED", "rows": []}
    else:
    ...
    required = ("compileall", "segmented_default_pytest", "gloo", "trace_checksums", "trace_mode_matrix", "deploy")
