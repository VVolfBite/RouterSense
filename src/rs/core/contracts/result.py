...
class ResultBundle:
    ...
    def validate(self) -> None:
        ...
        performance_metrics = self.details.get("performance_metrics")
        if performance_metrics is not None:
            from .performance import validate_performance_metrics_payload

            validate_performance_metrics_payload(performance_metrics)
