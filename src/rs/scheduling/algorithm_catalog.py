...
_ALGORITHMS: dict[str, AlgorithmMetadata] = {
    ...
    "O_local_phase_oracle": AlgorithmMetadata(
        ...
        display_name="Local Exact Bucket-Wave Oracle",
        ...
        joint_oracle_reference_id="O_joint_cp_sat_oracle",
        granularity_mode="dynamic_bucket_current",
        planning_scope="multiphase_phase_barrier",
        source="current_mainline",
        online_eligible=False,
        offline_eligible=True,
        heavy_solver=True,
        ...
        notes="Formal O_local uses the same canonical bucket/wave exact model as O_joint; only scope changes to phase barriers. Historical fluid Birkhoff is a separate reference baseline.",
    ),
    "O_joint_cp_sat_oracle": AlgorithmMetadata(
        algorithm_id="O_joint_cp_sat_oracle",
        display_name="Joint Exact Bucket-Wave Oracle",
        heuristic_family="oracle",
        role="o_joint_oracle",
        paired_algorithm_id=None,
        local_oracle_reference_id="O_local_phase_oracle",
        ...
        granularity_mode="dynamic_bucket_current",
        planning_scope="multiphase_rank_release_joint",
        source="current_mainline",
        online_eligible=False,
        offline_eligible=True,
        heavy_solver=True,
        ...
        notes="Compatibility ID retained. Formal O_joint is the in-tree exact runtime bucket/wave solver; the historical atomic CP-SAT model is sensitivity-only.",
    ),
