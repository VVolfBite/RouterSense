...
from .axes import PlannerAxes
from .families import FAMILY_SPECS, GlobalJointPlanner, build_scoped_planner
...
class EventP0123Planner:
    ...
    def __post_init__(self) -> None:
        ...
        self.planner_id = PlannerAxes("current", "p0123", "joint", "event", self.family).canonical_id
        self.planner_family = "joint_event_p0123_advisory"
...
class GlobalP0123Planner(EventP0123Planner):
    ...
    def __post_init__(self) -> None:
        super().__post_init__()
        self.planner_id = PlannerAxes("current", "p0123", "joint", "global", self.family).canonical_id
        self.planner_family = "joint_global_p0123_advisory"
        self._base = GlobalJointPlanner(self.family)
