...
def _normalize_information_mode(mode: str) -> str:
    ...
    if normalized not in {"p0_only", "p0_p1", "p0_p1_p2", "p0_p1_p2_p3"}:
...
def _scheduler_result_to_logical_plan(
    *,
    ...
    diagnostics = PolicyDiagnostics(
        ...
        p1_dependency_used=information_mode in {"p0_p1", "p0_p1_p2", "p0_p1_p2_p3"},
        p2_forecast_used=information_mode in {"p0_p1_p2", "p0_p1_p2_p3"},
        ...
        priority_components={
            ...
            "p3_return_weight": problem.options.p3_return_weight,
            "p3_return_advisory_used": information_mode == "p0_p1_p2_p3",
        ...
        diagnostics={
            **diagnostics.to_dict(),
            ...
            "future_information_mode": (
                ...
                if information_mode in {"p0_p1_p2", "p0_p1_p2_p3"}
...
class RouterSenseMultiphaseLookaheadPolicy:
    ...
    def build_logical_plan(self, problem: MultiPhaseSchedulingProblem) -> LogicalSchedulePlan:
        ...
        barrier_weight = self.p1_reservation_weight if self.information_mode in {"p0_p1", "p0_p1_p2", "p0_p1_p2_p3"} else 0.0
        prediction_weight = self.p2_hint_weight if self.information_mode in {"p0_p1_p2", "p0_p1_p2_p3"} else 0.0
        return_advisory_weight = problem.options.p3_return_weight if self.information_mode == "p0_p1_p2_p3" else 0.0
        if self.information_mode not in {"p0_p1_p2", "p0_p1_p2_p3"}:
        ...
        result = run_global_matching_scheduler(
            ...
            return_advisory_matrix=(
                [list(row) for row in problem.p3_next_return_advisory_matrix]
                if self.information_mode == "p0_p1_p2_p3"
                else None
            ),
            return_advisory_weight=float(return_advisory_weight),
        )
