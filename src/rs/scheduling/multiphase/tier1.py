    ...
    *,
    ...
    result = run_global_matching_scheduler(
        ...
        return_advisory_matrix=(
            ...
            if str(problem.options.information_mode) == "p0_p1_p2_p3"
            else None
        ),
        return_advisory_weight=(
            float(problem.options.p3_return_weight)
            if str(problem.options.information_mode) == "p0_p1_p2_p3"
            else 0.0
        ),
    )
    ...
    return _raw_schedule_to_plan(
        ...
        extra_diagnostics={
            ...
            "planning_horizon": ("p0123" if str(problem.options.information_mode) == "p0_p1_p2_p3" else "p012"),
            "execution_scope": "current_p0_p1",
            "p3_return_advisory_used": bool(str(problem.options.information_mode) == "p0_p1_p2_p3" and float(problem.options.p3_return_weight) > 0.0),
            "p3_return_weight": float(problem.options.p3_return_weight),
        },
    )
