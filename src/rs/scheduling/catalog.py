...
ALGORITHM_SPECS: tuple[AlgorithmSpec, ...] = (
    ...
    AlgorithmSpec(
        canonical_id="safe_pair_selector",
        display_name="Safe Paired Planner",
        family="safe_wrapper",
        scheduling_scope="paired_safe_wrapper",
        execution_model="compatibility_pair_selection",
        task_granularity="canonical_bucket",
        deployable=True,
        reference_only=False,
        online_eligible=True,
        ...
        supports_p2_hint=True,
        supports_safe_wrapper=True,
        aliases=("safe_pair", "safe-planner"),
        deprecated_aliases=("barrier_criticality_runtime_safe", "runtime_safe_u", "RS_safe_barrier_criticality", "safe-U"),
        builder_key="safe_pair_selector",
    ),
    AlgorithmSpec(
    ...
    AlgorithmSpec(
        ...
        notes="Compatibility canonical ID retained; the formal backend is the in-tree exact runtime bucket/wave solver, not optional CP-SAT.",
    ),
    AlgorithmSpec(
        ...
        notes="Compatibility canonical ID retained; Local and Joint share the exact runtime bucket/wave task and cost model and differ only by scope.",
    ),
)
