...
def write_resolved_configs(
    ...
    *,
    ...
    diagnostic_fallback_config: dict[str, Any] | None = None,
) -> None:
    ...
    if diagnostic_fallback_config is not None:
        write_yaml(layout.config_dir / "diagnostic_fallback.yaml", diagnostic_fallback_config)
