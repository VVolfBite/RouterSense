                ...
                policy_results.append(
                    {
                        ...
                        # Eligibility is the conjunction of the predictor, any
                        # calibration stage, and the selected policy. Do not let
                        # a policy default overwrite oracle/perfect-trace or
                        # oracle-total-calibration exclusions.
                        "evaluation_eligible": bool(
                            prediction_metrics["evaluation_eligible"]
                            and prediction_metrics.get("traffic_calibration_evaluation_eligible", True)
                            and plan.diagnostics.get("evaluation_eligible", True)
                        ),
                        "oracle_prediction": bool(
                            prediction_metrics["oracle_prediction"]
                            or not prediction_metrics.get("traffic_calibration_evaluation_eligible", True)
                        ),
...
__all__ = [
    ...
    "PREDICTOR_ROLLOUT_METADATA",
    "PREDICTOR_TO_SOURCE",
    "render_prediction_replay_markdown",
    "run_prediction_replay_suite",
]
