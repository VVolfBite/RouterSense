...
def test_reverse_policy_preserves_full_duplex_constraints() -> None:
    ...
    plan = resolve_policy(policy_name="reverse_bucket_reference", bucket_rows=16).build_plan(
        local_context=ctx0,
...
def test_reverse_policy_ignores_p2_hint() -> None:
    ...
    policy = resolve_policy(policy_name="reverse_bucket_reference", bucket_rows=16)
