...
from rs.runtime.online.megatron_ep.fingerprint import assert_expected_fingerprint
...
def test_host_api_drift_detection_raises_on_mismatch(tmp_path: Path) -> None:
    ...
    with pytest.raises(RuntimeError):
        assert_expected_fingerprint(str(path), {"dispatchers": {"layer": {"module_sha256": "def"}}})
