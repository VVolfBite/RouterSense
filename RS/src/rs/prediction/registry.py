...
_SPECS = {
    ...
    "mock_gate_replay": PredictorSpec("mock_gate_replay", category="expert_route", deployable=False, offline_only=True, historical_aliases=("MockGateReplayPredictor",)),
}
...
class PredictionRegistry:
    ...
    def create(predictor_id: str, config: Any | None = None) -> Predictor:
        ...
        if resolved == "linear":
            ...
            return LinearTrafficPredictor(ridge_lambda=ridge_lambda)
