...
FAST_ALGORITHMS: list[tuple[str, SchedulerFn]] = [
    ...
    ("U_gated_greedy_maximal_atomic", fast_schedule_u_gated_greedy_maximal_atomic),
    ...
    ("U_barrier_price_adaptive_matching_atomic", fast_schedule_u_barrier_price_adaptive_matching_atomic),
]
