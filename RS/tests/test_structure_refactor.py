...
def test_refactor_structure_exists() -> None:
    ...
    required = [
        ...
        root / "src/rs/scheduling/phase_local/p0p1_reservation_order.py",
        root / "src/rs/scheduling/phase_local/p0p1p2_hint_order.py",
        root / "src/rs/scheduling/phase_local/trivial_reverse_bucket.py",
        root / "src/rs/scheduling/multiphase/global_ready_set.py",
        root / "src/rs/scheduling/registry.py",
        root / "src/rs/scheduling/capabilities.py",
        root / "src/rs/scheduling/diagnostics.py",
        ...
        root / "configs/workload/smoke_prompts.json",
        root / "experiments/offline/collect_router_trace.py",
        root / "experiments/offline/analyze_next_layer_traffic_predictability.py",
        root / "experiments/online/collect_native_ep_trace.py",
        root / "experiments/online/probe_host_api.py",
        root / "experiments/online/run_noop_equivalence.py",
        root / "experiments/online/run_policy_correctness.py",
        root / "experiments/online/run_runtime_injection_smoke.py",
        root / "experiments/online/support/environment_validation.py",
        root / "experiments/online/support/phase_executor_artifacts.py",
