...
| --- | --- | --- | --- | --- | --- | --- |
| `O_local_phase_oracle` | `birkhoff_von_neumann_fluid` | `phase_local` | `true` | `false` | Single-phase fluid / crossbar makespan reference | Oracle-like only for local fluid makespan semantics. Not guaranteed optimal for wave count or setup-heavy metrics. |
