...
def test_offline_gate_rejects_ws2_partition_only_trace(tmp_path) -> None:
    ...
    try:
        ...
        try:
            ...
            raise AssertionError("expected offline gate to reject ws2 partition only trace")
        except RuntimeError as exc:
            assert "missing real dispatch/combine hidden transport" in str(exc)
    finally:
