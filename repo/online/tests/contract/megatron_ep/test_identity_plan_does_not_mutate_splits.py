...
def test_identity_runtime_assertions_can_report_unchanged_splits() -> None:
    ...
    runtime.assertion_state["native_splits_unchanged"] = True
    assert runtime.export_assertions()["native_splits_unchanged"] is True
