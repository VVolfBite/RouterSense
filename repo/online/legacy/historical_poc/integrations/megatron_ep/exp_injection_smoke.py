...
from integrations.megatron_ep.routersense.contracts import AssertionStatus, RouterSenseInjectionConfig  # noqa: E402
from integrations.megatron_ep.routersense.observer import RouterSenseObserver  # noqa: E402
...
def _source_archive_sha256(root: Path) -> str:
    tracked = [
        root / "integrations/megatron_ep/exp_injection_smoke.py",
        root / "integrations/megatron_ep/native_runtime.py",
        root / "integrations/megatron_ep/routersense/dispatcher_facade.py",
        root / "integrations/megatron_ep/routersense/policy/agreement.py",
        root / "integrations/megatron_ep/routersense/phase/adapter.py",
    ]
    h = hashlib.sha256()
    for path in tracked:
...
def _collect_source_provenance(base_dir: Path, dispatcher_fingerprint: dict[str, Any]) -> dict[str, Any]:
    ...
    payload = {
        **git,
        ...
        "smoke_entrypoint_sha256": _sha256_file(repo_root / "integrations/megatron_ep/exp_injection_smoke.py"),
        "native_runtime_sha256": _sha256_file(repo_root / "integrations/megatron_ep/native_runtime.py"),
        "dispatcher_facade_sha256": _sha256_file(repo_root / "integrations/megatron_ep/routersense/dispatcher_facade.py"),
        "agreement_py_sha256": _sha256_file(repo_root / "integrations/megatron_ep/routersense/policy/agreement.py"),
    }
