...
from integrations.megatron_ep.routersense.policy.base import RouterSensePolicy
...
def decode_plan_tensor(payload: list[int]) -> RouterSensePlan:
    ...
    from integrations.megatron_ep.routersense.policy.validation import build_phase_demands, summarize_plan_metrics
